...
function MobileMenu(props) {
    ...
    const showAddress = () => {
        if (!connectedWalletAddress || connectedWalletAddress.length < 42) return 'Invalid address.'
        let res = connectedWalletAddress.substr(0, 6) + '...' + connectedWalletAddress.substr(-4)
        if (data) {
        ...
        <>
            ...
            <div className="mobile-menu">
                ...
                <div className="flex flex-col">
                    {/* <button className="btn-mainnet flex items-center w-full mt-3" onClick={handleNetClick} disabled={!connectedWalletAddress}>
                        {activeNet ? (
